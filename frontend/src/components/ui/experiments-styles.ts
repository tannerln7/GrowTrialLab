export const experimentsStyles = {
  ...
  trayEditorAdjustRow: "mt-auto flex w-full items-center justify-between",
  trayEditorBadgeRow: "flex w-full items-center justify-center",
  ...
  trayGridCellIdInSlot: "w-full text-center",
