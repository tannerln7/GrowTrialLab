...
- [x] Placement Step 2 now uses mobile-first tray count controls (`+/-`) staged in `Tray Manager` with a bottom apply action; the standalone add-tray form and delete icon flow were removed in favor of one consistent save pattern.
