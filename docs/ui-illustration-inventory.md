...
| --- | --- | --- | --- | --- |
| ILL-001 | Not invited / access denied from `/api/me` | `frontend/app/experiments/page.tsx`, `frontend/app/experiments/new/page.tsx`, `frontend/app/experiments/[id]/setup/page.tsx` | `notInvited` | `UserX` |
