...
| high | Packet 4+ | Baseline lock exists, but unlock governance/audit is not fully formalized. | Add dedicated admin unlock endpoint and explicit audit trail for lock bypass actions. |
